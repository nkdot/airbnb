...
def data_imputation():
    ...
    listing_df['host_total_listings_count']=listing_df['host_total_listings_count'].fillna(1)
...
def reduce_groups():
    ...
    # data1[['No. Baths', 'Type Bath', 'Delete']] = data1['bathrooms_text'].str.split(' ', expand=True)
    # data1 = data1.drop(columns=['Delete', 'bathrooms_text'])
